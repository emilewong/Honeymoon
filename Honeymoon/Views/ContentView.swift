...
struct ContentView: View {
    ...
    @State private var cardRemoveTransaction = AnyTransition.trailingButton
            ...
            ZStack {
                ForEach(cardViews) { cardView in
                    cardView
                            ...
                            LongPressGesture(
                                ...
                                .onChanged({ (value) in
                                    ...
                                    if drag.translation.width < -self.dragAreaThreshold {
                                        self.cardRemoveTransaction = .leadingButton
                                    }
                                    
                                    if drag.translation.width > self.dragAreaThreshold {
                                        self.cardRemoveTransaction = .trailingButton
                                    }
                                })
                                .onEnded({ (value) in
                                    guard case .second(true, let drag?) = value else {
                        ...
                        ).transition(self.cardRemoveTransaction)
                }
                .padding(.horizontal)
            } //: ZSTACK
